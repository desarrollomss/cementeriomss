                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('mausoleos.update', $mausoleo->id) }}" method="POST"
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="ubicacion" list="ubicacion" class="form-control"
                                                value="{{ $mausoleo->ubicacion }}">
                                            <datalist id="ubicacion">
                                                @foreach ($mausoleos_info as $minfo)
                                                    <option value="{{ $minfo->descripcion }}">{{ $minfo->descripcion }}
                                                    </option>
                                                @endforeach
                                            </datalist>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required id="nro" name="numero" placeholder="Nro"
                                                class="form-control" value="{{ $mausoleo->numero }}">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" required id="nombres" name="nombres" placeholder="Nombres"
                                                class="form-control" value="{{ $mausoleo->nombres }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8">
                                        <div class="form-group">
                                            <img id="imagenSeleccionada" style="max-height: 200px"
                                                src="/cementerio/imagen/{{ $mausoleo->imagen }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="obs" list="obs" class="form-control" value="{{$mausoleo->obs}}">
                                            <datalist id="obs">
