                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                         ...
                         @endif
                            <form action="{{ route('tumbas.store') }}" method="post" class="form-horizontal"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                  <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                        <label for="nro">Codigo</label>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="ubicacion" list="ubicacion" class="form-control" required>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-2">
                                        <div class="form-group">
                                          ...
                                          <datalist id="nivel">
                                            @foreach ($nivel_tumbas as $tinfo)
                                                    <option value="{{ $tinfo->descripcion }}">{{ $tinfo->descripcion }}</option>
                                            @endforeach
                                          </datalist>                    
                                        </div>
                                    </div>
