                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                         ...
                         @endif
                            <form action="{{route('cuarteles.update', $cuartele->id)}}" method="POST" enctype="multipart/form-data">
                              @csrf
                              @method('PUT')
                              <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="ubicacion" list="ubicacion" class="form-control" value="{{$cuartele->ubicacion}}">
                                      <datalist id="ubicacion">
                                        @foreach ($cuarteles_info as $cinfo)
                                                <option value="{{ $cinfo->descripcion }}">{{ $cinfo->cod }}</option>
                                        @endforeach
                                      </datalist>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nivel" list="nivel" class="form-control" value="{{$cuartele->nivel}}">
                                        <datalist id="nivel">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" required id="nro" name="numero" placeholder="Nro"
                                            class="form-control" value="{{$cuartele->numero}}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required id="nombres" name="nombres" placeholder="Nombres"
                                            class="form-control" value="{{$cuartele->nombres}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required id="aparteno" name="ap_paterno"
                                            placeholder="Apellido Parterno" class="form-control" value="{{$cuartele->ap_paterno}}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required id="aparteno" name="ap_materno"
                                            placeholder="Apellido Marterno" class="form-control" value="{{$cuartele->ap_materno}}">
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-8">
                                    <div class="form-group">
                                        <img id="imagenSeleccionada" style="max-height: 200px" src="/cementerio/imagen/{{$cuartele->imagen}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-4">
                                    <div class="form-group">
                                        <input type="text" name="obs" list="obs" class="form-control" value="{{$cuartele->obs}}">
                                        <datalist id="obs">
