            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('cuarteles.update',$registro->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" value="2" name="tiporegistro" value="{{$registro->id_tipo_reg}}">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-5">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="ubicacion" id="codigo">
                                            ...
                                            <option value="{{$ubica->id}}" {{$ubica->id == $registro->id_ubicacion ? 'selected' : ''}}>{{ $ubica->descripcion}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="nivel" id="nivel">
                                            ...
                                            <option value="{{$nivel->id}}" {{$nivel->id == $registro->id_nivel ? 'selected' : ''}}>{{$nivel->descripcion}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
